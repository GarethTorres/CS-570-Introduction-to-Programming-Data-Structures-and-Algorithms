...
/**
 * Solution class for maze problems with backtracking.
 **/
public class Maze implements GridColors {
    ...
    public boolean findMazePath() {
        return findMazePath(0, 0); // Strat poiont: (0, 0) //
    }

    /**
     * Try to find the path through point (x, y).
     * 
     ...
     * @return If found a path through (x, y), true, otherwise return false
     */
    ...
    public boolean findMazePath(int x, int y) {
        ...
        // When cells are dead end or on barrier, the method returns false.
            ...
            return false;
        // When the cell is the exit of maze, the method recolor the cell and return
        // true.
    ...
    /**
     * Return a list of all the solutions to the maze, If there is no solution, then
    ...
    public void findMazePathStackBased(int x, int y, ArrayList<ArrayList<PairInt>> result, Stack<PairInt> trace) {
        ...
        // When the point represents barriers and cannot be part of the path, it will
        // return.
        else if (!maze.getColor(x, y).equals(NON_BACKGROUND)) {
            return;
        }
        // When the point is the exit of maze, it will return;
            ...
            // Copy the content of the stack into a list, then the list is added to the
            // result.
